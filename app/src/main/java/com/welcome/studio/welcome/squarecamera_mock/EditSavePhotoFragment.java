...
public class EditSavePhotoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(com.desmond.squarecamera.R.layout.squarecamera__fragment_edit_save_photo, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        final ImageView photoImageView = (ImageView) view.findViewById(com.desmond.squarecamera.R.id.photo);

        imageParameters.mIsPortrait =
                getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;

        final View topView = view.findViewById(com.desmond.squarecamera.R.id.topView);
        ...
        view.findViewById(com.desmond.squarecamera.R.id.save_photo).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (REQUEST_STORAGE == requestCode && data != null) {
            ...
            if (isGranted && view != null) {
                ImageView photoImageView = (ImageView) view.findViewById(com.desmond.squarecamera.R.id.photo);
