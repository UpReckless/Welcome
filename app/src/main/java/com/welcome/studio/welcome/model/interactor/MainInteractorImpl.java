...
public class MainInteractorImpl implements MainInteractor {
    ...
    public Observable<Boolean> auth() {
        ...
        return locationRepository.getLastKnownLocation()
                ...
                .onErrorReturn(throwable -> {
                    Log.e("AUTH ERROR", ""+throwable.getMessage());
                    return false;
                })
    ...
    private boolean checkUpdateUser(User user) {
        return userRepository.getUserCache().getPhotoRef().equals(user.getPhotoRef());
    }
    ...
    private Observable<User> updateUser(Uri photoRef) {
        User user = userRepository.getUserCache();
        user.setPhotoRef(String.valueOf(photoRef));
